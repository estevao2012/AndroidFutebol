...
public class PlayersFragment$$ViewInjector {
  public static void inject(Finder finder, final br.com.moobile.teste.timefutebol.views.main.players.PlayersFragment target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131034187, "field 'mTeamName'");
    ...
    view = finder.findRequiredView(source, 2131034188, "field 'mTeamSigla'");
    target.mTeamSigla = (android.widget.TextView) view;
  }

  public static void reset(br.com.moobile.teste.timefutebol.views.main.players.PlayersFragment target) {
